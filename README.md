...
> [!NOTE]
> This `MattRobotics/norma-core` fork contains the MATDOG ST3215 integration used by the custom quadruped project. The validated LF V25 calibrator performs native Station-mediated contact measurement, affine URDF alignment, transactional EEPROM provisioning and persistent-profile generation. The exact reviewed source is frozen on `release/matdog-lf-calibrator-v25`; operational details are documented in [`tools/matdog/README.md`](tools/matdog/README.md).
...
| **MATDOG LF calibrator** | [`tools/matdog/`](tools/matdog/) | Native LF end-stop measurement, affine q0 staging, EEPROM freeze and persistent calibration profile |
